...
class SimpleMotor:
    def __init__(self, motor_command=None, controller_active=True):
        # Simulation parameters
        self.dt = 0.002          # timestep [s]
        self.T = 5.0             # total simulation time [s]
        self.steps = int(self.T / self.dt)

        # Motor parameters
        self.J = 0.005            # inertia [kg.m^2]
        self.b = 0.05             # damping coefficient
        self.tau_max = 2.0       # max motor torque [Nm]
